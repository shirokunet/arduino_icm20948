...
bool MadgwickQuaternionUpdate(double ax, double ay, double az, double gx, double gy, double gz, double mx, double my, double mz, double deltat)
{
...
bool MahonyQuaternionUpdate(double ax, double ay, double az, double gx, double gy, double gz, double mx, double my, double mz, double deltat)
{
  // short name local variable for readability
  double q1 = q[0], q2 = q[1], q3 = q[2], q4 = q[3];
  double norm;
