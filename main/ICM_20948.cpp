...
ICM_20948_AGMT_t ICM_20948::getAGMT(void)
{
    ...
    is_quaternion_updated = MahonyQuaternionUpdate(
        accX() / 1000.0, 
        accY() / 1000.0, 
        accZ() / 1000.0, 
        gyrX() * DEG_TO_RAD,
...
double ICM_20948::magX(void)
{
    return getMagUT(agmt.mag.axes.x);
}

double ICM_20948::magY(void)
{
    return getMagUT(agmt.mag.axes.y);
}

double ICM_20948::magZ(void)
{
    return getMagUT(agmt.mag.axes.z);
}

double ICM_20948::getMagUT(int16_t axis_val)
{
    return (((double)axis_val) * 0.15);
}

double ICM_20948::accX(void)
{
    return getAccMG(agmt.acc.axes.x);
}

double ICM_20948::accY(void)
{
    return getAccMG(agmt.acc.axes.y);
}

double ICM_20948::accZ(void)
{
    return getAccMG(agmt.acc.axes.z);
}

double ICM_20948::getAccMG(int16_t axis_val)
{
    switch (agmt.fss.a)
    {
    case 0:
        return (((double)axis_val) / 16.384);
        break;
    case 1:
        return (((double)axis_val) / 8.192);
        break;
    case 2:
        return (((double)axis_val) / 4.096);
        break;
    case 3:
        return (((double)axis_val) / 2.048);
        break;
    default:
        return 0;
        break;
...
double ICM_20948::gyrX(void)
{
    return getGyrDPS(agmt.gyr.axes.x);
}

double ICM_20948::gyrY(void)
{
    return getGyrDPS(agmt.gyr.axes.y);
}

double ICM_20948::gyrZ(void)
{
    return getGyrDPS(agmt.gyr.axes.z);
}

double ICM_20948::getGyrDPS(int16_t axis_val)
{
    switch (agmt.fss.g)
    {
    case 0:
        return (((double)axis_val) / 131);
        break;
    case 1:
        return (((double)axis_val) / 65.5);
        break;
    case 2:
        return (((double)axis_val) / 32.8);
        break;
    case 3:
        return (((double)axis_val) / 16.4);
        break;
    default:
        return 0;
        break;
...
double ICM_20948::temp(void)
{
    return getTempC(agmt.tmp.val);
}

double ICM_20948::getTempC(int16_t val)
{
    return (((double)val) / 333.87) + 21;
}
...
void ICM_20948::updateTime()
{
  static uint32_t lastUpdate = 0;
  uint32_t Now = micros();

  // Set integration time by time elapsed since last filter update
  deltat_sec = ((Now - lastUpdate) / 1000000.0f);
  lastUpdate = Now;
}
