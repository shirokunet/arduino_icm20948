...
void loop() {
  ...
  if( myICM.dataReady() ){
    ...
    Serial.print(myICM.roll, 2);
    Serial.print(", ");
    Serial.print(myICM.pitch, 2);
    Serial.print(", ");
    Serial.print(myICM.yaw, 2);
    Serial.print(", ");
    // Serial.print(myICM.is_quaternion_updated);
    // Serial.print(", ");
    // Serial.print(myICM.q0, 2);
    // Serial.print(", ");
    // Serial.print(myICM.qx, 2);
    // Serial.print(", ");
    // Serial.print(myICM.qy, 2);
    // Serial.print(", ");
    // Serial.print(myICM.qz, 2);
    // Serial.print(", ");
    // Serial.print(myICM.deltat_sec, 2);
    // Serial.print(", ");
